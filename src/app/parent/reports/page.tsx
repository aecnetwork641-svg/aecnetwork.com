...
export default async function ParentReportsPage({
  ...
  return (
    <PortalShell role="Parent Portal" navItems={PARENT_NAV} title="Reports">
      {!scope && (
        <div className="card">
      ...
      {scope && (
        <>
          ...
          />
          <div className="card">
            <p className="text-sm text-aec-navy/60">Downloadable academic and attendance reports for your selected child.</p>
