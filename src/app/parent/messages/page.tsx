...
export default async function ParentMessagesPage({
  ...
  return (
    <PortalShell role="Parent Portal" navItems={PARENT_NAV} title="Messages">
      {!scope && (
        <div className="card">
      ...
      {scope && (
        <>
          ...
          />
          <div className="card">
            <p className="text-sm text-aec-navy/60">Direct messages between you and your selected child's teachers.</p>
