...
export default async function ParentTimetablePage({
  ...
  return (
    <PortalShell role="Parent Portal" navItems={PARENT_NAV} title="Timetable">
      {!scope && (
        <div className="card">
      ...
      {scope && (
        <>
          ...
          />
          <div className="card">
            <p className="text-sm text-aec-navy/60">Your selected child's weekly TimetableSlot schedule.</p>
