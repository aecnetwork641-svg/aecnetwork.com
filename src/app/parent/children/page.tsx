...
export default async function ParentChildrenPage({
  ...
  return (
    <PortalShell role="Parent Portal" navItems={PARENT_NAV} title="Children">
      {!scope && (
        <div className="card">
      ...
      {scope && (
        <>
          ...
          />
          <div className="card">
            <p className="text-sm text-aec-navy/60">All children linked to your account (ParentProfile.children) with quick links into each one's records.</p>
